    ...
    <footer className="bg-gray-900 dark:bg-black text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-sm md:text-base font-semibold mb-4">Contact Us</h4>
            <ul className="space-y-2 text-gray-400 text-sm">
              <li className="flex items-center gap-2">
                ...
                <p className="text-sm sm:text-base">123 Food Street, Cuisine City</p>
              </li>
              <li className="flex items-center gap-2">
                <svg
                  className="w-4 h-4"
              ...
              <li className="flex items-center gap-2">
                ...
                <p className="text-sm sm:text-base">Mon-Sun: 10:00 AM - 10:00 PM</p>
              </li>
            </ul>
          </div>
        </div>
